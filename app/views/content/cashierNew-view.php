<div class="container is-fluid mb-6">
	<h1 class="title">Trabajador</h1>
	<h2 class="subtitle"><i class="fas fa-cash-register fa-fw"></i> &nbsp; Nuevo Trabajador</h2>
</div>
...
<div class="container pb-6 pt-6">
	...
	<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/cajaAjax.php" method="POST" autocomplete="off" >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Numero de Trabajador <?php echo CAMPO_OBLIGATORIO; ?></label>
				  	<input class="input" type="text" name="caja_numero" pattern="[0-9]{1,5}" maxlength="5" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Nombre o código de Trabajador <?php echo CAMPO_OBLIGATORIO; ?></label>
				  	<input class="input" type="text" name="caja_nombre" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ:# ]{3,70}" maxlength="70" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Inicio del Trabajador <?php echo CAMPO_OBLIGATORIO; ?></label>
